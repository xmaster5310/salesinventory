 ...
 * @author DELL
 */
public class DuePurchase extends javax.swing.JFrame {
...
// decrement totalEngDaysCount until its value becomes 0
    ...
    public void fetch() {
        try {
            ...
            String q = "select id as Id, item_no as 'Item No',item_price as 'Item Price',item_sell_date as 'Purchase Date',item_name as 'ItemName',item_model as 'ItemModel',item_quantity as 'Quantity',item_total as 'Total',customer_name as 'Party Name',due as 'Due Purchase' from due_purchase ORDER BY id DESC";
...
//        JOptionPane.showMessageDialog(null,newDate);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Purchase Due Report");
    ...
    private void table1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            PurchaseDuePayReport pdpr = new PurchaseDuePayReport();
            DefaultTableModel model2 = (DefaultTableModel) pdpr.table1.getModel();
            for (int i = 0; i < indexs.length; i++) {
                row[0] = model1.getValueAt(indexs[i], 0);
//            JOptionPane.showMessageDialog(null,row[0]);
                row[1] = model1.getValueAt(indexs[i], 1);
                row[2] = model1.getValueAt(indexs[i], 2);
//            JOptionPane.showMessageDialog(null,row[2]);
...
//        JOptionPane.showMessageDialog(null,i);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (v <= 0) {
            ...
            String customerName = dm.getValueAt(i, 8).toString();

            String sql12 = "insert into purchase_item(item_no,item_buying_price,receive_date,item_type,item_category,item_quantity,total_price,vat_amount,total_vat,party,due_paid,due_left,cash_due,payed_date,iscashdue) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            try {
            ...
            String sql = "update due_purchase set "
