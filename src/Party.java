    ...
    public Party() {
     ...
     public void fetch() {
        try {
            ...
            String q = "select id as Id,party_name as 'Party Name',party_address as 'Party Address',party_contact_no as 'Party Contact',pan_number as 'Pan Number' from party ORDER BY id DESC";            
//            String q = "select item_date as Receiving_Date from item ORDER BY id DESC";
    ...
    private void initComponents() {
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 340, 90, -1));
        ...
        customer_contact1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                customer_contact1KeyTyped(evt);
            }
        });
        jPanel3.add(customer_contact1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 240, 160, -1));

        jLabel14.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        jLabel14.setText("Party Contact");
        jPanel3.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 120, -1));
 ...
 //customer validation
    ...
    {
         if (customer_contact1.getText().equals("")) {             
            return false;
        }
        return true;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jButton1.getText() == "Update")
        {
            ...
            if (row >= 0) {
                ...
                + "party_name ='" + customer_name.getText() + "' ,"
                + "party_address ='" + customer_address.getText() + "' , "
                + "party_contact_no ='" + customer_contact.getText() + "' , "
                + "pan_number ='" + customer_contact1.getText() + "' "
                + "where id = " + cell;
                try {
            ...
            {
                JOptionPane.showMessageDialog(null,"Please enter Party Address");
                return;
            }
            if(!validationContact())
            {
                JOptionPane.showMessageDialog(null,"Please enter Party Contact No.");
                return;
            }
            
           String cName = customer_name.getText();
            String sqlll = "select * from party where party_name ='"+ cName + "'";
            ...
            rs = pst.executeQuery(sqlll);     
             if(rs.next() == false)
             {
                String sql = "insert into party(party_name,party_address,party_contact_no,pan_number) values(?,?,?,?)";
            try {                         
                pst = conn.prepareStatement(sql);                
                pst.setString(1, customer_name.getText());
                pst.setString(2, customer_address.getText());
                pst.setString(3, customer_contact.getText());               
                pst.setString(4, customer_contact1.getText());
                pst.execute();
    ...
    private void table1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table1MouseClicked
        ...
        customer_contact.setText(dm.getValueAt(i, 3).toString());
        customer_contact1.setText(dm.getValueAt(i,4).toString());
...
//        }
    ...
    private void customer_contact1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_customer_contact1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_customer_contact1KeyTyped
