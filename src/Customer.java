...
public class Customer extends javax.swing.JFrame {
    ...
    public void fetch() {
        try {
            ...
            String q = "select id as Id,customer_name as 'Customer Name',customer_address as 'Customer Address',customer_pan_no as 'Pan No',customer_contact_no as 'Customer Contact' from customer ORDER BY id DESC";
//            String q = "select item_date as Receiving_Date from item ORDER BY id DESC";
    ...
    private void initComponents() {
        ...
        customer_pan_no = new javax.swing.JTextField();
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 110, 20));

        jLabel5.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        jLabel5.setText("Customer Pan No");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 120, 20));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, 90, -1));
        ...
        jPanel3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 120, -1));
        ...
        jPanel3.add(customer_contact, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 240, 160, -1));

        customer_pan_no.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                customer_pan_noActionPerformed(evt);
            }
        });
        jPanel3.add(customer_pan_no, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 200, 160, -1));

        jLabel6.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        jLabel6.setText("Customer Address");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 120, 20));
        ...
        setSize(new java.awt.Dimension(1128, 620));
    ...
    public boolean validationCustomerName() {
    ...
    public boolean validationCustomerAddress() {
    ...
    public boolean validationContact() {
        if (customer_contact.getText().equals("")) {
            return false;
        }
        return true;
    }

    //customer panno validation

    public boolean validationpan() {
        if (customer_pan_no.getText().equals("")) {
            return false;
        }
        return true;
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if (jButton1.getText() == "Update") {
            int row = table1.getSelectedRow();
            if (row >= 0) {
                //getting id column of table
                String cell = table1.getModel().getValueAt(row, 0).toString();
                String sql = "update customer set "
                        + "customer_name ='" + customer_name.getText() + "' ,"
                        + "customer_address ='" + customer_address.getText() + "' , "
                        + "customer_pan_no ='" + customer_pan_no.getText() + "' , "
                        + "customer_contact_no ='" + customer_contact.getText() + "' "
                        + "where id = " + cell;
                try {
            ...
            String sqlll = "select * from customer where customer_name ='" + cName + "'";

            try {
                pst = conn.prepareStatement(sqlll);
                rs = pst.executeQuery(sqlll);
                if (rs.next() == false) {
                    String sql = "insert into customer(customer_name,customer_address,customer_pan_no,customer_contact_no) values(?,?,?,?)";
                    try {
                        pst = conn.prepareStatement(sql);
                        pst.setString(1, customer_name.getText());
                        pst.setString(2, customer_address.getText());
                        pst.setString(3, customer_pan_no.getText());
                        pst.setString(4, customer_contact.getText());
                        pst.execute();
                    ...
                    JOptionPane.showMessageDialog(null, "CustomerName already Exist");
                    clear();
                }
    ...
    private void table1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table1MouseClicked
        ...
        dm = (DefaultTableModel) table1.getModel();
        customer_name.setText(dm.getValueAt(i, 1).toString());
        customer_address.setText(dm.getValueAt(i, 2).toString());
        customer_pan_no.setText(dm.getValueAt(i, 3).toString());
        customer_contact.setText(dm.getValueAt(i, 4).toString());
    ...
    private void customer_pan_noActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customer_pan_noActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_customer_pan_noActionPerformed
    ...
    private javax.swing.JTextField customer_pan_no;
